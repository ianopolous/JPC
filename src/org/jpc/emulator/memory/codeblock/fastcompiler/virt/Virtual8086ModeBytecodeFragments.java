 ...
 * @author Chris Dennis
 */
public class Virtual8086ModeBytecodeFragments extends BytecodeFragments
{
    ...
    private Virtual8086ModeBytecodeFragments()
    {
    }

    static {
        UCodeMethodParser p = new UCodeMethodParser(Virtual8086ModeUCodeStaticMethods.class, operationArray, operandArray, externalEffectsArray, explicitThrowArray);
        p.parse();
    }
