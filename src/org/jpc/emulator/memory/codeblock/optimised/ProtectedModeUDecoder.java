...
{ 
	...
	int opcode = 0;
	int opcodePrefix = 0;
	int prefices = operandSizeIs32Bit ? PREFICES_OPERAND | PREFICES_ADDRESS : 0x00;
	int bytesRead = 0;
	int modrm = -1;
	int sib = -1;
        boolean lock = false;
	...
	case 0xf34: working.write(SYSENTER); break; //SYSENTER
	case 0xf35: working.write(SYSEXIT); break; //SYSEXIT
