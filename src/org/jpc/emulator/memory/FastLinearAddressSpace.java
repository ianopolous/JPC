 ...
 * @author Chris Dennis
 */
public class FastLinearAddressSpace extends LinearAddressSpace implements HardwareComponent
{
     ...
     * configuration.
     */
    public FastLinearAddressSpace()
    {
        System.out.println("Using Fast Linear Address Space");
        baseAddress = 0;
        lastAddress = 0;
        pagingDisabled = true;
