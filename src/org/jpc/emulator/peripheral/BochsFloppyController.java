...
public class BochsFloppyController implements IODevice, DMATransferCapable, HardwareComponent, TimerResponsive
{
    ...
    static class FloppyDrive
    {
        ...
        public FloppyDrive(int fd, int sectors_per_track, int sectors, int tracks, int heads, int type, int write_protected, int status_changed, boolean vvfat_floppy, BlockDevice vvfat)
        {
            this.fd = fd;
...
void close_media(floppy_t *media)
{
  if (media->fd >= 0) {
