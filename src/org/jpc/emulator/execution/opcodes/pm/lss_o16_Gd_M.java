...
public class lss_o16_Gd_M extends Executable
{
    final int op1Index;
    final Address op2;

    public lss_o16_Gd_M(int blockStart, Instruction parent)
    {
    ...
    public lss_o16_Gd_M(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
