...
public class lss_o16_Gd_M_mem extends Executable
{
    final int op1Index;
    final Address op2;

    public lss_o16_Gd_M_mem(int blockStart, Instruction parent)
    {
    ...
    public lss_o16_Gd_M_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
