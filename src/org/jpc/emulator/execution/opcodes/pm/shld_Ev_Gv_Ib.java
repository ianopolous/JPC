...
public class shld_Ev_Gv_Ib extends Executable
{
    final int op1Index;
    final int op2Index;
    final int immb;
    ...
    public shld_Ev_Gv_Ib(int blockStart, Instruction parent)
    {
    ...
    public Branch execute(Processor cpu)
    {
        ...
        if(immb != 0)
        {
            ...
            cpu.flagOp2 = shift;
            long rot = ((long)(0xFFFF&op1.get16()) << (2*16)) | ((0xFFFF&op2.get16()) << 16) | (0xFFFF&op1.get16());
