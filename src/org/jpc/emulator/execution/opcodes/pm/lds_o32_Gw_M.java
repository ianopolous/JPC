...
public class lds_o32_Gw_M extends Executable
{
    final int op1Index;
    final Address op2;

    public lds_o32_Gw_M(int blockStart, Instruction parent)
    {
    ...
    public lds_o32_Gw_M(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
