...
public class les_o16_Gd_M_mem extends Executable
{
    final int op1Index;
    final Address op2;

    public les_o16_Gd_M_mem(int blockStart, Instruction parent)
    {
    ...
    public les_o16_Gd_M_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
