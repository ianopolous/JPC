...
public class lfs_o32_Gw_M_mem extends Executable
{
    final int op1Index;
    final Address op2;

    public lfs_o32_Gw_M_mem(int blockStart, Instruction parent)
    {
    ...
    public lfs_o32_Gw_M_mem(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
