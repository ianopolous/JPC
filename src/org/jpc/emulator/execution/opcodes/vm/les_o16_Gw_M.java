...
public class les_o16_Gw_M extends Executable
{
    final int op1Index;
    final Address op2;

    public les_o16_Gw_M(int blockStart, Instruction parent)
    {
    ...
    public les_o16_Gw_M(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
