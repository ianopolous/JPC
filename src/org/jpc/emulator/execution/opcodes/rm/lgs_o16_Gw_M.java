...
public class lgs_o16_Gw_M extends Executable
{
    final int op1Index;
    final Address op2;

    public lgs_o16_Gw_M(int blockStart, Instruction parent)
    {
    ...
    public lgs_o16_Gw_M(int blockStart, int eip, int prefices, PeekableInputStream input)
    {
